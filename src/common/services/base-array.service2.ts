...
export abstract class BaseArrayService2<
  ModelGeneral,
  Dto_Create_SubModel,
...
> {
  ...
  //     (sudDoc) => String(sudDoc[this.idField]) === String(subDocId),
  //   );
  ...
  //   const subDocument = arraySubdocuments.find(
  //     (sudDoc) => String(sudDoc[this.idField]) === String(idSubDocRestore),
  //   );
  //   console.log('document:                ', document);
  //   return subDocument;
  // }
  ...
  //     throw new NotFoundException(
  //       `No hay subdocumentos ${this.idField} marcados como eliminados"`,
  //     );
  //   }
