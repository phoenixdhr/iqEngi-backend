...
// import { CreateCalificacionInput } from 'src/modules/calificacion/dtos/create-calificacion.input';
// import { UpdateCalificacionInput } from 'src/modules/calificacion/dtos/update-calificacion.input';
...
//   ): Promise<Categoria> {
//     const newCategoria = new this.categoriaModel(createCalificacionInput);
...
//   async update(
//     id: string,
//     updateCategoriaInput: UpdateCalificacionInput,
//   ): Promise<Categoria> {
//     const updatedCategoria = this.categoriaModel.findByIdAndUpdate(
//       id,
